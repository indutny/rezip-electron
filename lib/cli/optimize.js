...
const FIXED_MTIME = new Date();
FIXED_MTIME.setFullYear(2024);
FIXED_MTIME.setMonth(0);
FIXED_MTIME.setDate(1);
FIXED_MTIME.setSeconds(0);
FIXED_MTIME.setMinutes(0);
FIXED_MTIME.setHours(0);
